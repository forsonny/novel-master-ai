...
issue = repo.create_issue(
    title="Exported from Novel Master",
    body="This issue was created by Novel Master. [Task ID: 123]"
)

# Add a comment or update the issue to include a backlink
issue.create_comment("Linked to Novel Master task #123")
```
[3][5]
...
- For bidirectional linking, store the GitHub issue URL in your task data and the Novel Master task ID in the GitHub issue body or as a label/comment.
...
await octokit.issues.createComment({
  ...
  body: "Linked to Novel Master task #123"
});
```
