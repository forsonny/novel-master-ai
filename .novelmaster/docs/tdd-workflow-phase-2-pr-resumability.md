...
Located at `.novelmaster/templates/pr-body.md`:
...
Full execution report: `.novelmaster/reports/runs/{runId}/`

---

🤖 Generated with [Novel Master](https://github.com/cline/novel-master) autonomous TDD workflow
```
...
To create PR manually:
  gh pr create \
    ...
    --body-file .novelmaster/reports/runs/2025-01-15-142033/pr.md
...
**Resume logic:**
1. Load state from `.novelmaster/reports/runs/<runId>/state.json`
...
Options:
  ...
  2. Lower thresholds in .novelmaster/config.json
