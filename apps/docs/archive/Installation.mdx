...
description: "This guide walks you through setting up Novel Master in your development environment."
---

## Initial Setup

<Tip>
  MCP (Model Control Protocol) provides the easiest way to get started with Novel Master directly in your editor.
</Tip>
...
<AccordionGroup>
  <Accordion title="Option 1: Using MCP (Recommended)" icon="sparkles">
    <Steps>
      ...
      <Step title="Prompt the AI to initialize Novel Master">
        > "Can you please initialize novelmaster-ai into my project?"
        ...
        **The AI will:**
        ...
        5. **Use natural language commands** to interact with Novel Master:
