---
title: "Configuration"
description: "Configure Novel Master through environment variables in a .env file"
---

## Required Configuration

<Note>
  Novel Master requires an Anthropic API key to function. Add this to your `.env` file:
