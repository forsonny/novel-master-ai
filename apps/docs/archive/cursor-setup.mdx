...
description: "Learn how to set up and use Novel Master with Cursor AI"
---

## Setting up Cursor AI Integration

<Check>
  Novel Master is designed to work seamlessly with [Cursor AI](https://www.cursor.so/), providing a structured workflow for AI-driven development.
</Check>
