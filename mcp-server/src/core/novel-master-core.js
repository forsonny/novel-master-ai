...
import { readManuscriptSummaryDirect } from './direct-functions/read-manuscript-summary.js';
import { validateNRDDirect } from './direct-functions/validate-nrd.js';
import { validateSceneQualityDirect } from './direct-functions/validate-scene-quality.js';
import { validateNRDComplianceDirect } from './direct-functions/validate-nrd-compliance.js';
import { compareTagsDirect } from './direct-functions/compare-tags.js';
import { estimateWorkflowCostDirect } from './direct-functions/estimate-workflow-cost.js';
...
export const directFunctions = new Map([
	...
	['readManuscriptSummaryDirect', readManuscriptSummaryDirect],
	['validateNRDDirect', validateNRDDirect],
	['validateSceneQualityDirect', validateSceneQualityDirect],
	['validateNRDComplianceDirect', validateNRDComplianceDirect],
	['compareTagsDirect', compareTagsDirect],
	['estimateWorkflowCostDirect', estimateWorkflowCostDirect]
]);
...
export {
	...
	scopeUpDirect,
	scopeDownDirect,
	readManuscriptSummaryDirect,
	validateNRDDirect,
	validateSceneQualityDirect,
	validateNRDComplianceDirect,
	compareTagsDirect,
	estimateWorkflowCostDirect
};
