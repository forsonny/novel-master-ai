...
describe('Logger - MCP Integration', () => {
	...
	beforeEach(() => {
		...
		originalEnv = {
			...
			NOVEL_MASTER_MCP: process.env.NOVEL_MASTER_MCP,
		...
		delete process.env.NOVEL_MASTER_MCP;
	...
	describe('Environment variable detection', () => {
		...
		it('should detect log level from environment', () => {
			const originalEnv = process.env.TM_LOG_LEVEL;
			process.env.TM_LOG_LEVEL = 'DEBUG';
			...
			if (originalEnv === undefined) {
				...
				process.env.TM_LOG_LEVEL = originalEnv;
			}
		});
	});
});
