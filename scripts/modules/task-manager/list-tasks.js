			...
			console.log(
				boxen(
					chalk.hex('#FF8800').bold(
						...
						'\n\n' +
						// Use nextItem.id
						`${chalk.cyan('Start working:')} ${chalk.yellow(`novel-master set-status --id=${nextItem.id} --status=in-progress`)}\n` +
						// Use nextItem.id
						`${chalk.cyan('View details:')} ${chalk.yellow(`novel-master show ${nextItem.id}`)}`,
					{
