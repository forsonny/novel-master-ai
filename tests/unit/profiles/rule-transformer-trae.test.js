...
[novelmaster.mdc](mdc:.cursor/rules/novelmaster.mdc).`;
		...
		// Verify transformations - no novelmaster subdirectory for Trae
		expect(transformedContent).toContain('(.trae/rules/dev_workflow.md)'); // File path transformation - no novelmaster subdirectory for Trae
		expect(transformedContent).toContain('(.trae/rules/novelmaster.md)'); // File path transformation - no novelmaster subdirectory for Trae
