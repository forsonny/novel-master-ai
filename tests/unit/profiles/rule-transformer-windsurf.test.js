...
[novelmaster.mdc](mdc:.cursor/rules/novelmaster.mdc).`;
		...
		// Verify transformations - no novelmaster subdirectory for Windsurf
		expect(transformedContent).toContain('(.windsurf/rules/dev_workflow.md)'); // File path transformation - no novelmaster subdirectory for Windsurf
		expect(transformedContent).toContain('(.windsurf/rules/novelmaster.md)'); // File path transformation - no novelmaster subdirectory for Windsurf
